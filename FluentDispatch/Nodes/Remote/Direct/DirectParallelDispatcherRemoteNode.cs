...
{
    internal sealed class DirectParallelDispatcherRemoteNode<TInput> : DirectParallelProcessor<TInput>,
        IDirectDispatcherRemoteNode<TInput>
    {
        ...
        /// <summary>
        /// <see cref="DirectParallelDispatcherRemoteNode{TInput}"/>
        /// </summary>
        ...
        public DirectParallelDispatcherRemoteNode(
