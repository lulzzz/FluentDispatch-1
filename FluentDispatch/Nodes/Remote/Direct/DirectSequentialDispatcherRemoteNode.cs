...
{
    internal sealed class DirectSequentialDispatcherRemoteNode<TInput> : DirectSequentialProcessor<TInput>,
        IDirectDispatcherRemoteNode<TInput>
    {
        /// <summary>
        /// <see cref="ILogger"/>
        /// </summary>
        ...
        /// <summary>
        /// <see cref="DirectSequentialDispatcherRemoteNode{TInput}"/>
        /// </summary>
        ...
        public DirectSequentialDispatcherRemoteNode(
