...
{
    internal sealed class DirectParallelDispatcherLocalNode<TInput> : DirectParallelProcessor<TInput>,
        IDirectDispatcherLocalNode<TInput>
    {
        ...
        /// <summary>
        /// <see cref="DirectParallelDispatcherLocalNode{TInput}"/>
        /// </summary>
        ...
        public DirectParallelDispatcherLocalNode(
