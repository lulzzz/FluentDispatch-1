...
using FluentDispatch.Processors.Direct;
using Microsoft.Extensions.Logging;
using Polly;

namespace FluentDispatch.Nodes.Local.Direct
{
    internal sealed class DirectSequentialDispatcherLocalNode<TInput> : DirectSequentialProcessor<TInput>,
        IDirectDispatcherLocalNode<TInput>
    {
        /// <summary>
        /// <see cref="ILogger"/>
        /// </summary>
        ...
        /// <summary>
        /// <see cref="DirectSequentialDispatcherLocalNode{TInput}"/>
        /// </summary>
        ...
        public DirectSequentialDispatcherLocalNode(
        ...
        protected override async Task Process(TInput item, IProgress<double> progress,
